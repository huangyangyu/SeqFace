...
BOOST_PYTHON_MODULE(_caffe) {
  ...
  bp::class_<Net<Dtype>, shared_ptr<Net<Dtype> >, boost::noncopyable >("Net",
    ...
    .def("memory_used", &Net<Dtype>::memory_used)
  ...
  if (boost::python::converter::registry::query(
    boost::python::type_id <shared_ptr<Net<Dtype> > >()) == NULL) {
    bp::register_ptr_to_python<shared_ptr<Net<Dtype> > >();
  }
  ...
  if (boost::python::converter::registry::query(
    boost::python::type_id <shared_ptr<Blob<Dtype> > >()) == NULL) {
    bp::register_ptr_to_python<shared_ptr<Blob<Dtype> > >();
  }
  ...
  if (boost::python::converter::registry::query(
    boost::python::type_id <shared_ptr<Solver<Dtype> > >()) == NULL) {
    bp::register_ptr_to_python<shared_ptr<Solver<Dtype> > >();
  }
