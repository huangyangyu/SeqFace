...
class Aligner(caffe.Net):
    ...
    def align(self, input, fastresize=False):
        ...
        if numbox > 0:
            ...
            stage1_out = "/data/image_server/user/ouxiaotian/MTCNN/mtcnn-caffe/Experiments/plates/stage1_out_square.pkl"
            out_boxes = sorted(total_boxes, key=lambda x:x[-1],reverse=True)
            print "OK"
