#ifndef CAFFE_T_MARGIN_INNER_PRODUCT_LAYER_HPP_
#define CAFFE_T_MARGIN_INNER_PRODUCT_LAYER_HPP_
...
class T_MarginInnerProductLayer : public Layer<Dtype> {
 public:
  explicit T_MarginInnerProductLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "T_MarginInnerProduct"; }
...
#endif  // CAFFE_T_MARGIN_INNER_PRODUCT_LAYER_HPP_
