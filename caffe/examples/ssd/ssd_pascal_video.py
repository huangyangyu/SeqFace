...
run_soon = True
# The video file path
video_file = "examples/videos/test2.mpg"
...
with open(test_net_file, 'w') as f:
    f.write('name: "{}_test"'.format(model_name))
    f.write(str(net.to_proto()))
shutil.copy(test_net_file, job_dir)

# Create job file.
#test_net_file = "/root/test/caffe/models/VGGNet/VOC0712Plus/SSD_300x300_ft/test.prototxt"##
#pretrain_model = "/root/test/caffe/models/VGGNet/VOC0712Plus/SSD_300x300_ft/train.caffemodel"##
test_net_file = "/data/image_server/task/detect/car/ssd_test/trainer_car/deploy_video.prototxt"##
pretrain_model = "/data/image_server/task/detect/car/ssd_test/trainer_car/train.caffemodel"##
print test_iter
